...
return {
	...
	ANNOUNCE_NODAYSLEEP = "Who would ever sleeps in the morning? Ghost?",
	...
	ANNOUNCE_DAMP = "Oh , Water everywhere",
	ANNOUNCE_WET = "It's like going swimming ",
	...
	DESCRIBE =
	{
		...
		BAT="They sure look like furry ball with wings",
		BATBAT = "I wonder if I could fly with two of these.",
		BATWING="Hope it tastes like chicken",
